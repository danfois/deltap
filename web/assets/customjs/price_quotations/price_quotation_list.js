                            ...
                            },
                            {
                                ...
                                \<div class="dropdown ' + dropup + '">\
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">\
                                        ...
                                        \<a class="dropdown-item" href="javascript:void(0);" onclick="genericModalFunction(\'GET\', \'' + window.location.origin + '/send-pqd-modal-'+row.idv+'\', {}, {\'initializeWidgets\' : true, \'initializeForm\' : true, \'formJquery\' : \'form_pq_email\'})"><i class="la la-envelope"></i> Invia al Destinatario</a>\
						...
						<div class="dropdown ' + dropup + '">\
							<a href="#" class="btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" data-toggle="dropdown">\
						  	...
						  	<div class="dropdown-menu dropdown-menu-right">\
						    	...
						    	<a class="dropdown-item" target="_blank" href="' + window.location.origin + '/print/price-quotation-' + row.idv + '"><i class="la la-eye"></i> Vedi Preventivo</a>\
						    	...
						    	<a class="dropdown-item" href="javascript:void(0);" onclick="genericModalFunction(\'GET\', \'' + window.location.origin + '/send-pq-modal-'+row.idv+'\', {}, {\'initializeWidgets\' : true, \'initializeForm\' : true, \'formJquery\' : \'form_pq_email\'})"><i class="la la-envelope"></i> Invia al Destinatario</a>\
