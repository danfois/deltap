var QualificationLetterList = function () {
    ...
    var qualificationLetterList = function () {
        ...
        var options = {
            data: {
                ...
                source: {
                    read: {
                        url: '/json/driving-documents/qualification-letter'
                    }
                },
                pageSize: 20
            },
                        ...
                        data: {
                            ...
                            source: {
                                read: {
                                    ...
                                    params: {'id': t.data.idv, 'type': 'qualification-letter'}
                                }
                            },
                            pageSize: 10
                        },
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: function (row, index, datatable) {
                        var dropup = (datatable.getPageSize() - index) <= 4 ? 'dropup' : '';
                        return '\
						<a href="javascript:void(0);" onclick="genericDelete(\'delete-qualification-letter\', \'La carta qualificazione conducente non è stata eliminata!\', {\'id\' : \'' + row.idv + '\'})" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="Elimina">\
							<i class="la la-trash"></i>\
						</a>\
					';
                    }
                    ...
                    pagination: {
                        items: {
                            default: {
                                ...
                                input: "Numero di Pagina",
                                select: "Seleziona il numero della pagina"
                            }, info: "Visualizzando {{start}} - {{end}} dì {{total}} carte qualificazione conducente"
                        }
                    }
                }
            }
    ...
    return {
        init: function () {
            qualificationLetterList();
        }
    };
}();

$(document).ready(function () {
    QualificationLetterList.init();
});