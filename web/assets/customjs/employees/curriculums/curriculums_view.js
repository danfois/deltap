                        ...
                        data: {
                            ...
                            source: {
                                read: {
                                    ...
                                    params: {'id': t.data.idv, 'type': 'curriculum'}
                                }
                            },
                            pageSize: 10
                        },
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: function (row, index, datatable) {
                        var dropup = (datatable.getPageSize() - index) <= 4 ? 'dropup' : '';
                        return '\
						<a href="javascript:void(0);" onclick="genericDelete(\'delete-curriculum\', \'Il curriculum non è stato eliminato!\', {\'id\' : \'' + row.idv + '\'})" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="Elimina">\
							<i class="la la-trash"></i>\
						</a>\
					';
                    }
                    ...
                    pagination: {
                        items: {
                            default: {
                                ...
                                input: "Numero di Pagina",
                                select: "Seleziona il numero della pagina"
                            }, info: "Visualizzando {{start}} - {{end}} dì {{total}} curriculum"
                        }
                    }
                }
            }
