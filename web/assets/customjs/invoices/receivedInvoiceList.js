                        ...
                        data: {
                            ...
                            source: {
                                read: {
                                    ...
                                    params: {'id': t.data.idv, 'invoiceType': 'receivedInvoice'}
                                }
                            },
                            pageSize: 10
                        },
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: function (row, index, datatable) {
						...
						<a href="print/received-invoice-' + row.idv + '" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="Vedi Fattura">\
							<i class="la la-eye"></i>\
						</a>\
					';
                    }
